...
ModelDataPotensiDesa modelDataPotensiDesaFromJson(String str) => ModelDataPotensiDesa.fromJson(json.decode(str));

String modelDataPotensiDesaToJson(ModelDataPotensiDesa data) => json.encode(data.toJson());
...
class ModelDataPotensiDesa {
    ...
    factory ModelDataPotensiDesa.fromJson(Map<String, dynamic> json) => ModelDataPotensiDesa(
        message: json["message"],
        total: json["total"],
        totalPage: json["total_page"],
        activePage: json["active_page"],
        data: List<PotensiDesa>.from(json["data"].map((x) => PotensiDesa.fromJson(x))),
    );
